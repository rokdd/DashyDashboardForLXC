...
```
wget https://raw.githubusercontent.com/rokdd/DashyDashboardForLXC/main/Alpine%20Scripts/install-dashy-alpine3.16.sh && chmod +x install-dashy-alpine3.16.sh && ./install-dashy-alpine3.16.sh
```
